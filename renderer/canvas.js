...
class GuaCanvas extends GuaObject {
    ...
    drawHalfTriangle(a, b, c, flag=1, cos) {
      //flag判断是上半还是下半, 1是上半
        // log('color',a,b,c)
        let sx, ex, sc, ec
        ...
        for (let y = downV.position.y; y > upV.position.y; y--) {
            ...
            this.drawScanline(v1, v2, cos)
            // break
        }

    }

    drawTriangle(v1, v2, v3, cos) {
        // log('v123',v1, v2, v3)
        let {w, h} = this
        let minV, maxV
        ...
        this.drawHalfTriangle(a, b, c, 1, cos)
        this.drawHalfTriangle(a, b, c, 0, cos)
    }
    ...
    calculateCos(light, worldTriangleNormal, worldTrianglePosition) {
